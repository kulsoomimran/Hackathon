...
type ProductCardProps = {
  image: StaticImageData; // For imported static images
  title?: string;
  description?: string;
  price?: string;
};
  ...
  return (
    <div className="w-screen bg-gray-100">
      ...
      <div className="text-center px-6 py-12 bg-white">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-gray-900">NIKE AIR MAX PULSE</h1>
      ...
      <div className="bg-gray-50 py-16">
        <div className="max-w-5xl mx-auto text-center">
          <Image src={Running} alt="Running Man" width={1200} height={600} className="rounded-lg" />
      ...
      {/* Jordan Flight Essentials Section */}
      <div className="bg-gray-50 py-16">
        <div className="text-center">
          <Image src={Jordan} alt="Jordan Flight Essentials" width={1200} height={600} />
          <h1 className="mt-8 text-3xl md:text-4xl font-semibold text-gray-900">FLIGHT ESSENTIALS</h1>
          <p className="mt-4 text-lg text-gray-600">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 px-6 py-16 bg-white">
        <div className="text-center">
          <Image src={Men} alt="Shop Men" width={300} height={300} className="rounded-lg" />
          <h3 className="mt-4 text-xl font-bold">Men</h3>
        </div>
        <div className="text-center">
          <Image src={Women} alt="Shop Women" width={300} height={300} className="rounded-lg" />
          <h3 className="mt-4 text-xl font-bold">Women</h3>
        </div>
        <div className="text-center">
          <Image src={Kids} alt="Shop Kids" width={300} height={300} className="rounded-lg" />
          <h3 className="mt-4 text-xl font-bold">Kids</h3>
        </div>
      </div>
    </div>
  );
...
const ProductCard: React.FC<ProductCardProps> = ({ image, title = "", description = "", price = "" }) => (
  <div className="text-center">
    <Image src={image} alt={title} width={300} height={300} className="rounded-lg mx-auto" />
